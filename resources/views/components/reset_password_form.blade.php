                ...
                <div class="w-full relative">
                    <div class="mt-4">
                        <div class="mb-5 text-center font-base text-gray-700">
                            <span class="font-mono font-semibold text-xl"> sign up </span>
                        </div>
                        <form class="mt-8" method="post" action="{{ route("post.reset") }}">
                            @csrf
{{--                            <input type="hidden" name="token" value="{{ $token }}">--}}
                            ...
                            <button type="submit" class="mt-3 text-lg font-semibold bg-purple-600 w-full text-white rounded-lg px-6
                                py-3 block shadow-xl hover:opacity-80"> reset password
                            </button>
                    </form>
                </div>
            </div>
